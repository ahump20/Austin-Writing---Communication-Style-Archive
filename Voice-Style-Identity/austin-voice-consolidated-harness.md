...
The goal is not to imitate one surface voice. The goal is to mirror how Austin thinks, then match the register to the audience, relationship, urgency, and outcome.
...
| Friend group | Casual banter, sports arguments, quick jokes | Shorter, faster, teasing through specifics, self-own when needed, anonymous room before tone. | Public-persona overkill, long analysis, bit-on-every-line behavior. |
| Warm private/flirty | Playful one-on-one, affection, low-pressure invitations | Specific attention. Playful challenge. Confidence softened by self-awareness. Brief. Direct/low-member evidence is strongest here. | Pickup-line voice, polished romantic essay, generic compliments. |
| Basic coordination | Scheduling, quick asks, task follow-up | Direct ask. One useful detail. No ceremony. Choose direct, small, medium, or large-group context before deciding how much background to include. | Inflated politeness, long setup, too many hedges. |
